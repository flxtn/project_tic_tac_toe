  ...
  return (
    ...
    >
      <div
        data-id="modal"
        className={clsx(
          "rounded-lg bg-white min-h-[320px] relative",
          "flex flex-col",
          {
      ...
      >
        ...
        w-8 h-8 bg-white/10 rounded
         ...
         absolute top-0 left-[calc(100%+12px)] transition-colors"
        >
...
UIModal.Footer = function UiModalFooter({ children, className }) {
  return (
    <div className={clsx(className, "mt-auto p-6 flex justify-end gap-4")}>
      {children}
    </div>
  );
};
